...
class OpticalNetworkEnv(gym.Env):
    ...
    def __init__(self, topology=None, episode_length=1000, load=10, mean_service_holding_time=10800.0,
                 ...
                 node_request_probabilities=None, seed=None, k_paths=5, incremental_traffic_percentage=80):
        ...
        self.services_processed_bit_rate = {}
        self.services_processed_bit_rate[100] = 1
        self.services_processed_bit_rate[200] = 1
        self.services_processed_bit_rate[400] = 1


        self.services_accepted = 0
        self.services_accepted_bit_rate = {}
        self.services_accepted_bit_rate[100] = 1
        self.services_accepted_bit_rate[200] = 1
        self.services_accepted_bit_rate[400] = 1
        self.service_blocked_due_fragmentation = 0
        self.service_blocked_due_lack_resource = 0
        ...
        # deploying the incremental and dynamic traffic
        self.incremental_traffic_percentage = incremental_traffic_percentage
        self.incremental_dynamic_proportion_mean_time = 2
        self.load = load
        self.mean_service_holding_time = mean_service_holding_time
        self.mean_service_inter_arrival_time = 0
        self.mean_service_inter_arrival_time_dynamic = 0
        #load_incremental = load*self.incremental_traffic_percentage/100
       # load_dynamic= load*(1-self.incremental_traffic_percentage/100)
        self.set_load(load=load, mean_service_holding_time=self.mean_service_holding_time, Incremental_flag= False)
        self.set_load(load=load, mean_service_holding_time=self.mean_service_holding_time, Incremental_flag= True)
        self.service = None
    ...
    def set_load(self, load=None, mean_service_holding_time=None, Incremental_flag = True):
        """
        ...
        if Incremental_flag:
            ...
            self.mean_service_inter_arrival_time_dynamic = 1 / float(load / float((mean_service_holding_time)/self.incremental_dynamic_proportion_mean_time))
    ...
    def observation(self):
        return {'current_service': self.service,
